/*
V tej datoteki ogre dobi vse dodatne datoteke, ki jih potrebuje za izvajanje:
teksture
shader programe
materjale
3Dmodele
...
Prav tako prebere konfiguracijsko, ki doloèi kako se bo ogre izvajal grafièno.
...
bool OgreFramework::initOgre(Ogre::String wndTitle, OIS::KeyListener *pKeyListener, OIS::MouseListener *pMouseListener)
{
	...
	if (!m_pRoot->restoreConfig()) return m_pRoot->showConfigDialog();
	...
	m_pClient->Startup(1, 30, &socketDesc, 1);
